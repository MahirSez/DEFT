...
set terminal pdfcairo font "Gill Sans,18" dashed rounded linewidth 1 size 6.0in,2.2in
#set output 'CDF.eps'
set output 'CdfComparisonDPILBChain3.pdf'

set multiplot layout 1,3 font ",126"
...
set xlabel "Latency time (us)" font ",18" offset 0,0.5
set ylabel "CDF" font ",18" offset 1.8
set xtics auto 600 font ",18" nomirror
set ytics font ",18" nomirror
set ytics 0.2
unset log y
#set logscale x 10
set yrange [0:1]
...
set title "DPI" font ",18" offset 0,-0.6
file_b=ARG1
...
unset ylabel
unset ytics
set title "Load Balancer" font ",18"  offset 0,-0.6
...
unset ylabel
unset ytics
set title "Chain 3" font ",18"  offset 0,-0.6
#set origin 0.44,-0.08
#set size 0.55,1.1
set xrange [500:1500]
set xtics auto 500 font ",18" nomirror
set key left top maxrows 4 samplen 1.5 font ",12" #autotitle columnhead
#unset key


file_b='baseline1\Chain3_lat_7_0_gnu.csv'
print "Baseline name        : ", file_b

file_rl='reinforce\Chain3_lat_reinforce_0_gnu.csv'
print "REINFORCE name        : ", file_rl

file_ra='ftmb\Chain3_lat_ftmb_0_gnu.csv'
print "FTMB name        : ", file_ra

file_rp='pico\Chain3_lat_pico_0_gnu.csv'
print "Pico name        : ", file_rp
