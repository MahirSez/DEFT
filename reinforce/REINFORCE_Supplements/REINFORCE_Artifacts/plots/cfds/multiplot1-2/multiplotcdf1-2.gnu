...
set title "DPI" font ",10" offset 0,-0.6
file_b=ARG1
...
plot file_b u ($1/1000):(1./$2) smooth cumulative with l ls 2 t 'Baseline', \
     file_rl u ($1/1000):(1./$2) smooth cumulative with l ls 1 t 'Local', \
     file_ra u ($1/1000):(1./$2) smooth cumulative with l ls 3 t 'Remote', \
...
#
unset ylabel
set title "Load Balancer" font ",10"  offset 0,-0.6
