#call 'DPI.gnu' 'DPI_lat_baseline_0_gnu.csv' 'DPI_lat_res_lcl_0_gnu.csv' 'DPI_lat_res_all_0_gnu.csv'  'DPI_lat_pico_0_gnu.csv'
...
set key left top maxrows 4 width -1.5 font ",24" #autotitle columnhead
...
set xlabel "Latency time (us)" offset 0,0.5 font ",24"
set ylabel "CDF" offset 1.7,0 font ",24"
set xtics font ",24" nomirror
set ytics font ",24" nomirror
unset log y
set logscale x 10
#set yrange [0:1]
#set xrange [0:3000]
