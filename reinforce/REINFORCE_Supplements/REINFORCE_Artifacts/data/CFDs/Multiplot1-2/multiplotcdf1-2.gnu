...
set multiplot layout 1,2 font ",24"
set key left top maxrows 4 width -1.5 font ",16" #autotitle columnhead
...
set xlabel "Latency time (us)" font ",16"
set ylabel "CDF" font ",16"
set xtics font ",16" nomirror
set ytics font ",16" nomirror
unset log y
set logscale x 10
#set yrange [0:1]
#set xrange [0:3000]
