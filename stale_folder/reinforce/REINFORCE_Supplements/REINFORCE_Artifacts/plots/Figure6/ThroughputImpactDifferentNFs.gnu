...
set xtics rotate by -15 offset -1.5,0.05  font ",10"
...
'ThroughputImpactforDiffNFs.csv' using 2:($2-$3):($2+$3):xtic(1) ti "Baseline" fs pattern 6 lc 3, '' u 4:($4-$5):($4+$5) ti "Local" fs pattern 7 lc 1, '' u 6:($6-$7):($6+$7) ti "Remote" fs pattern 1  lc 2, '' u 8:($8-$9):($8+$9) ti "Pico*" fs pattern 2 lc 8, \
#
