...
public class TestTimedMoveAll extends TestTimed
{
	...
	protected static Logger log = LoggerFactory.getLogger(TestTimedMoveAll.class.getSimpleName());
	...
	{
		log.debug("TestTimedMoveAll initalruleSetup() Called");
		Middlebox mb1 = middleboxes.get("mb1");
		synchronized(this.activeMbs)	// No-usage found
	...
	{
		log.debug("TestTimedMoveAll initiateOperation Called");
		Middlebox mb1 = middleboxes.get("mb1");
